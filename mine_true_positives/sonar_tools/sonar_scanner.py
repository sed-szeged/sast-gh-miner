...
import subprocess
import re
from tp_utils import list2csr
import time


class SonarScanner:

    def __init__(self, token: str, project_name: str, lang: str, files_list: list, log_file: str):
        """
...
class MultiSonarScanner:
    ...
    def __init__(self, token: str, projects_and_chunks: dict, lang: str, good_files_csv: str, log_file: str):
        self.lang = lang
        self.token = token
    ...
    def bulk_sonar_scan(self) -> dict:
        ...
        for project, borders in self.projects.items():
            ...
            scanner = SonarScanner(token=self.token,
